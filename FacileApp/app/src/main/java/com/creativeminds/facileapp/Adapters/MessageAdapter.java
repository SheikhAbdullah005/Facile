...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.MessageViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MessageViewHolder messageViewHolder, int i) {
       Message chat = messagesListModel.get(i);
        messageViewHolder.setData(messagesListModel.get(i));
        if(i==messagesListModel.size()-1){
            if(chat.isIsseen()){
                messageViewHolder.txt_seen.setText("Seen");
            }else{
    ...
    public class MessageViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        TextView show_message, receiverName,txt_seen;
...
//                                    }
    ...
    public int getItemViewType(int position) {
        if(messagesListModel.get(position).getSender().equals(sharedPref.getfirebaseSenderId())){
