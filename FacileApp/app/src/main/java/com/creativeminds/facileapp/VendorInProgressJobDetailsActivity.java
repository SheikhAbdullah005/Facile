...
public class VendorInProgressJobDetailsActivity extends AppCompatActivity implements OnMapReadyCallback, View.OnClickListener {
    ...
    private String email,phoneNumber, jobId,vendorId, name, service, phone, city, price,estimatedTime, totalDistance,serviceId;
    private Button jobDetails, chat, complaints, acceptReq, calculatePrice,startFinalPrice, calculateFinalPrice,venderCancelButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        venderCancelButton= findViewById(R.id.venderCancelButton);
        ...
        venderCancelButton.setOnClickListener(this);
                        ...
                        if(e != null) {
                            ...
                            try {
                                ...
                                JSONObject jsonObject = new JSONObject(result.getResult());
                                    updatedBill = jsonObject.getString("total_bill");
                                    if (updatedBill.equalsIgnoreCase("")) {

                                       // misc.showToast(updatedBill);
                                        ...
                                        esTime.setVisibility(GONE);
                                        finalPr.setVisibility(View.VISIBLE);
                                        sPrice.setText("Initial Price: " + price);
                                        finalPr.setText("Final Price: " + updatedBill);
                                        //fetchFinalPrice();
                                        paymentBox(updatedBill);
    ...
    public void onClick(View v) {
        ...
        if(v.getId() == venderCancelButton.getId()) {
        ...
        if(v.getId() == calculateFinalPrice.getId()) {
            venderCancelButton.setClickable(false);
            finalTimeLogic();
        }
                ...
                .setCallback(new FutureCallback<Response<String>>() {
                    ...
                    public void onCompleted(Exception e, Response<String> result) {
                        if(e != null) {
                            ...
                            Intent cancel = new Intent(getApplication(), ServiceHomeActivity.class);
...
//                                c_cnic.setText("CNIC: " + customerCnic);
    ...
    public void timeLogic(){
        ...
        Ion.with(this)
            ...
            Toast.makeText(this,"Lun exception",Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void paymentBox(String price){
        ...
        cancelDialog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.dismiss();
                Intent intent = new Intent(getApplicationContext(), ProviderJobsActivity.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    private void getTimeDist(){
        Ion.with(this)
                .load("https://maps.googleapis.com/maps/api/directions/json?origin="+current_latitude+","+current_longitude+"&destination="+customerLat+","+customerLon+"&sensor-false&mode-driving&key=AIzaSyDFFj1K7J4iE1ZLjLvxyVH7K12KNKlhYAI")
                .asString()
                .withResponse()
                .setCallback(new FutureCallback<Response<String>>() {
                    @Override
